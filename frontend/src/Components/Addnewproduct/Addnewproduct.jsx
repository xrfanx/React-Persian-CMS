...
export default function Addnewproduct({ getAllProducts }) {
  ...
  return (
    <div className="flex flex-col gap-4 p-6 bg-(--purple) rounded-tr-4xl rounded-bl-4xl w-full mt-4 transition-all duration-300 ease-in-out">
      <h1 className="text-2xl text-(--white) font-bold">افزودن محصول جدید</h1>
      ...
      <form onSubmit={addNewProduct} className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4 items-center">
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-name" className="text-(--white) whitespace-nowrap text-base">
              نام محصول
            </label>
            <input
              type="text"
              ...
              className="border border-(--purpleHard) bg-(--white) w-48 rounded-lg outline-none text-(--purpleHard) text-sm p-2 transition-all duration-300 ease-out placeholder:text-(--purple)"
              value={newProdutName}
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-price" className="text-(--white) whitespace-nowrap text-base">
              قیمت محصول
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-description" className="text-(--white) whitespace-nowrap text-base">
              موجودی محصول
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-category" className="text-(--white) whitespace-nowrap text-base">
              عکس محصول
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-colors" className="text-(--white) whitespace-nowrap text-base">
              تعداد رنگ بندی
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-sale" className="text-(--white) whitespace-nowrap text-base">
              میزان فروش محصول
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center justify-between gap-2">
            <label htmlFor="product-popularity" className="text-(--white) whitespace-nowrap text-base">
              میزان محبوبیت
            </label>
            <input
              type="text"
        ...
        <div className="flex justify-center mt-4">
          <button
            type="submit"
            className="bg-(--white) text-(--purpleHard) border-0 outline-none rounded-lg py-2 px-8 cursor-pointer font-bold transition-all duration-300 ease-out text-lg hover:bg-(--purpleHard) hover:text-(--white)"
          >
            ثبت محصول
          </button>
        </div>
